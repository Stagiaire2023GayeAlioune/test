...
def main():
    ...
    if methode1=="8" or "9" or "10" or "11" or "12" or "13" or "14" or "15" or "16" or "17" or "18": 
        if methode2=="Non":
    ...
    else if methode1=="Weekend" and methode2=="Non":
    ...
    else if methode1=="Weekend" and methode2=="Oui":
